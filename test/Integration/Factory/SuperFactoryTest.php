...
use Reinfi\DependencyInjection\Factory\SuperWiringFactory;
...
use Reinfi\DependencyInjection\Test\Service\ServiceWithPartialAnnotation;
 ...
 * @group integration
 */
class SuperFactoryTest extends AbstractIntegrationTest
{
    use ProphecyTrait;
    ...
    public function testItCreatesServiceWithDependencies(): void
    {
        ...
        $factory = new SuperWiringFactory();

        $instance = $factory->createService(
            $container,
            ServiceWithPartialAnnotation::class,
            ServiceWithPartialAnnotation::class
        );
